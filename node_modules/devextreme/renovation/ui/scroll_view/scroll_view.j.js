...
var ScrollView = function(_ScrollViewWrapper) {
    ...
    _proto.scrollTo = function(targetLocation) {
        var _this$viewRef5;
        return null === (_this$viewRef5 = this.viewRef) || void 0 === _this$viewRef5 ? void 0 : _this$viewRef5.scrollTo.apply(_this$viewRef5, arguments)
    };
    _proto.scrollToElement = function(element, offset) {
        var _this$viewRef6;
        var params = [this._patchElementParam(element), offset];
        return null === (_this$viewRef6 = this.viewRef) || void 0 === _this$viewRef6 ? void 0 : _this$viewRef6.scrollToElement.apply(_this$viewRef6, _toConsumableArray(params.slice(0, arguments.length)))
    };
    _proto.scrollHeight = function() {
        var _this$viewRef7;
        return null === (_this$viewRef7 = this.viewRef) || void 0 === _this$viewRef7 ? void 0 : _this$viewRef7.scrollHeight.apply(_this$viewRef7, arguments)
    };
    _proto.scrollWidth = function() {
        var _this$viewRef8;
        return null === (_this$viewRef8 = this.viewRef) || void 0 === _this$viewRef8 ? void 0 : _this$viewRef8.scrollWidth.apply(_this$viewRef8, arguments)
    };
    _proto.scrollOffset = function() {
        var _this$viewRef9;
        return null === (_this$viewRef9 = this.viewRef) || void 0 === _this$viewRef9 ? void 0 : _this$viewRef9.scrollOffset.apply(_this$viewRef9, arguments)
    };
    _proto.scrollTop = function() {
        var _this$viewRef10;
        return null === (_this$viewRef10 = this.viewRef) || void 0 === _this$viewRef10 ? void 0 : _this$viewRef10.scrollTop.apply(_this$viewRef10, arguments)
    };
    _proto.scrollLeft = function() {
        var _this$viewRef11;
        return null === (_this$viewRef11 = this.viewRef) || void 0 === _this$viewRef11 ? void 0 : _this$viewRef11.scrollLeft.apply(_this$viewRef11, arguments)
    };
    _proto.clientHeight = function() {
        var _this$viewRef12;
        return null === (_this$viewRef12 = this.viewRef) || void 0 === _this$viewRef12 ? void 0 : _this$viewRef12.clientHeight.apply(_this$viewRef12, arguments)
    };
    _proto.clientWidth = function() {
        var _this$viewRef13;
        return null === (_this$viewRef13 = this.viewRef) || void 0 === _this$viewRef13 ? void 0 : _this$viewRef13.clientWidth.apply(_this$viewRef13, arguments)
    };
    _proto.toggleLoading = function(showOrHide) {
        var _this$viewRef14;
        return null === (_this$viewRef14 = this.viewRef) || void 0 === _this$viewRef14 ? void 0 : _this$viewRef14.toggleLoading.apply(_this$viewRef14, arguments)
    };
    _proto.startLoading = function() {
        var _this$viewRef15;
        return null === (_this$viewRef15 = this.viewRef) || void 0 === _this$viewRef15 ? void 0 : _this$viewRef15.startLoading.apply(_this$viewRef15, arguments)
    };
    _proto.finishLoading = function() {
        var _this$viewRef16;
        return null === (_this$viewRef16 = this.viewRef) || void 0 === _this$viewRef16 ? void 0 : _this$viewRef16.finishLoading.apply(_this$viewRef16, arguments)
    };
    _proto.updateHandler = function() {
        var _this$viewRef17;
        return null === (_this$viewRef17 = this.viewRef) || void 0 === _this$viewRef17 ? void 0 : _this$viewRef17.updateHandler.apply(_this$viewRef17, arguments)
    };

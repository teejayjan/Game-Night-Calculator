...
var Scrollbar = function(_InfernoComponent) {
    ...
    _proto.createEffects = function() {
        return [new _inferno2.InfernoEffect(this.pointerDownEffect, []), new _inferno2.InfernoEffect(this.pointerUpEffect, []), new _inferno2.InfernoEffect(this.mouseEnterEffect, [this.props.showScrollbar]), new _inferno2.InfernoEffect(this.mouseLeaveEffect, [this.props.showScrollbar]), new _inferno2.InfernoEffect(this.syncScrollLocation, [this.props.containerHasSizes, this.props.scrollLocation, this.props.direction, this.props.rtlEnabled, this.props.maxOffset, this.props.scrollLocationChange])]
    };
    _proto.updateEffects = function() {
        var _this$_effects$, _this$_effects$2, _this$_effects$3;
        null === (_this$_effects$ = this._effects[2]) || void 0 === _this$_effects$ ? void 0 : _this$_effects$.update([this.props.showScrollbar]);
        null === (_this$_effects$2 = this._effects[3]) || void 0 === _this$_effects$2 ? void 0 : _this$_effects$2.update([this.props.showScrollbar]);
        null === (_this$_effects$3 = this._effects[4]) || void 0 === _this$_effects$3 ? void 0 : _this$_effects$3.update([this.props.containerHasSizes, this.props.scrollLocation, this.props.direction, this.props.rtlEnabled, this.props.maxOffset, this.props.scrollLocationChange])
    };
    ...
    _proto.initHandler = function(event, thumbScrolling, offset) {
    ...
    _proto.moveHandler = function(delta, minOffset, maxOffset, thumbScrolling) {
        var resultDelta = delta;
        if (thumbScrolling) {
            resultDelta = -Math.round(delta / this.containerToContentRatio)
        }
        var isOutBounds = !(0, _math.inRange)(this.props.scrollLocation, maxOffset, minOffset);
        if (isOutBounds) {
            resultDelta *= OUT_BOUNDS_ACCELERATION
        }
        this.scrollStep(resultDelta, minOffset, maxOffset)
    };
    _proto.scrollStep = function(delta, minOffset, maxOffset) {
        var moveToValue = this.props.scrollLocation + delta;
        this.moveTo(this.props.bounceEnabled ? moveToValue : (0, _clamp_into_range.clampIntoRange)(moveToValue, minOffset, maxOffset))
    };
    ...
    _createClass(Scrollbar, [{
        ...
        get: function() {
            var _classesMap;
            var classesMap = (_classesMap = {}, _defineProperty(_classesMap, _consts.SCROLLABLE_SCROLLBAR_CLASS, true), _defineProperty(_classesMap, "dx-scrollbar-".concat(this.props.direction), true), _defineProperty(_classesMap, _consts.SCROLLABLE_SCROLLBAR_ACTIVE_CLASS, this.state.expanded), _defineProperty(_classesMap, _consts.HOVER_ENABLED_STATE, this.isExpandable), _defineProperty(_classesMap, "dx-state-invisible", this.hidden), _defineProperty(_classesMap, "dx-state-hover", this.isExpandable && this.state.hovered), _classesMap);
        ...
        get: function() {
            ...
            return this.__getterCache.thumbStyles = (_ref = {}, _defineProperty(_ref, _this6.dimension, _this6.scrollSize || THUMB_MIN_SIZE), _defineProperty(_ref, "transform", _this6.isNeverMode ? "none" : _this6.thumbTransform), _ref);
            var _ref
        }
    }, {
        key: "thumbTransform",

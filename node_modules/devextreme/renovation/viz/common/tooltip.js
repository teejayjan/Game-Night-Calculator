...
var Tooltip = function(_InfernoComponent) {
    ...
    _proto.createEffects = function() {
        ...
        return [new _inferno2.InfernoEffect(this.setHtmlText, [this.props.border, this.props.color, this.props.customizeTooltip, this.props.data, this.props.font, this.props.visible]), new _inferno2.InfernoEffect(this.calculateSize, [this.props.visible, this.props.x, this.props.y, this.state.textSize, this.state.cloudSize]), new _inferno2.InfernoEffect(this.eventsEffect, [this.props.eventData, this.props.onTooltipHidden, this.props.onTooltipShown, this.props.visible, this.props.arrowLength, this.props.offset, this.props.x, this.props.y, this.state.canvas, this.props.paddingLeftRight, this.props.paddingTopBottom, this.state.textSize, this.state.currentEventData]), new _inferno2.InfernoEffect(this.checkContainer, [this.props.visible]), new _inferno2.InfernoEffect(this.setCanvas, [this.props.container, null === (_this$props$rootWidge = this.props.rootWidget) || void 0 === _this$props$rootWidge ? void 0 : _this$props$rootWidge.current])]
    };
    _proto.updateEffects = function() {
        ...
        null === (_this$_effects$2 = this._effects[1]) || void 0 === _this$_effects$2 ? void 0 : _this$_effects$2.update([this.props.visible, this.props.x, this.props.y, this.state.textSize, this.state.cloudSize]);
    ...
    _createClass(Tooltip, [{
        ...
        get: function() {
            var _this$props4 = this.props,
                restProps = (_this$props4.argumentFormat, _this$props4.arrowLength, _this$props4.arrowWidth, _this$props4.border, _this$props4.className, _this$props4.color, _this$props4.container, _this$props4.contentTemplate, _this$props4.cornerRadius, _this$props4.customizeTooltip, _this$props4.data, _this$props4.enabled, _this$props4.eventData, _this$props4.font, _this$props4.format, _this$props4.interactive, _this$props4.location, _this$props4.offset, _this$props4.onTooltipHidden, _this$props4.onTooltipShown, _this$props4.opacity, _this$props4.paddingLeftRight, _this$props4.paddingTopBottom, _this$props4.rootWidget, _this$props4.rtl, _this$props4.shadow, _this$props4.shared, _this$props4.visible, _this$props4.x, _this$props4.y, _this$props4.zIndex, _objectWithoutProperties(_this$props4, _excluded));
            return restProps
        }
    }]);
    return Tooltip

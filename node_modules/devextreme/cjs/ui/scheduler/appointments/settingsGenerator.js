...
var DateGeneratorBaseStrategy = function() {
    ...
    _proto.generate = function(appointmentAdapter) {
        var itemResources = (0, _utils.getResourcesFromItem)(this.options.resources, this.dataAccessors.resources, this.rawAppointment);
    ...
    _proto._canProcessNotNativeTimezoneDates = function(appointment) {
        ...
        return !_utilsTimeZone.default.isEqualLocalTimeZone(this.timeZone, appointment.startDate)
    };
    ...
    _proto._createExtremeRecurrenceDates = function() {
        ...
        if (this.timeZone) {
            ...
            var daylightOffset = _utilsTimeZone.default.getDaylightOffsetInMs(startViewDate, endViewDateByEndDayHour);
            if (daylightOffset) {
    ...
    _proto._createRecurrenceOptions = function(appointment, groupIndex) {
        ...
        return {
            ...
            getPostProcessedException: function(date) {
                if ((0, _type.isEmptyObject)(_this6.timeZone) || _utilsTimeZone.default.isEqualLocalTimeZone(_this6.timeZone, date)) {
                    return date
                }
    ...
    _proto._getGroupIndices = function(appointmentResources) {
        ...
        if (appointmentResources && this.loadedResources.length) {
            ...
            result = (0, _utils.getResourceTreeLeaves)((function(field, action) {
                return (0, _utils.getDataAccessors)(_this8.options.dataAccessors.resources, field, action)
...
var AppointmentSettingsGenerator = function() {
    ...
    _proto3._prepareAppointmentInfos = function(dateSettings, cellPositions) {
        var _this11 = this;
        var infos = [];
        cellPositions.forEach((function(_ref) {
            ...
            var dateText = _this11._getAppointmentDateText(sourceAppointment);
            var info = {

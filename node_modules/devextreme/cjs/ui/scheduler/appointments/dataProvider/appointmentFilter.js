...
var AppointmentFilterBaseStrategy = function() {
    ...
    _proto2.getPreparedDataItems = function(dataItems) {
        var _this6 = this;
        var result = [];
        null === dataItems || void 0 === dataItems ? void 0 : dataItems.forEach((function(rawAppointment) {
            ...
            (0, _utils2.replaceWrongEndDate)(rawAppointment, startDate, endDate, _this6.appointmentDuration, _this6.dataAccessors);
            var adapter = (0, _appointmentAdapter.createAppointmentAdapter)(rawAppointment, _this6.dataAccessors, _this6.timeZoneCalculator);
            ...
            var hasRecurrenceRule = !!(null !== recurrenceRule && void 0 !== recurrenceRule && recurrenceRule.match(regex).length);
            var item = {
...
var AppointmentFilterVirtualStrategy = function(_AppointmentFilterBas) {
    ...
    _proto3.filter = function(preparedItems) {
        ...
        groupsInfo.forEach((function(item) {
            ...
            var allDayPanel = _this7.viewDataProvider.getAllDayPanel(groupIndex);
    ...
    _proto3.filterPreparedItems = function(_ref3) {
        var _this8 = this;

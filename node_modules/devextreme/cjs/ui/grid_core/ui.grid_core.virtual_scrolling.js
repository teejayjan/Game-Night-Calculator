...
var VirtualScrollingDataSourceAdapterExtender = function() {
    ...
    var result = {
        ...
        _handleDataLoading: function(options) {
            ...
            if (false === this.option(LEGACY_SCROLLING_MODE) && loadPageCount > 1) {
            ...
            data: function() {
                var members = {
                    ...
                    _getRowsScrollDataOptions: function() {
                        ...
                        return {
                            ...
                            loadedItemCount: function() {
                                var _that$_allItems;
                                var insertRowCount = (null === (_that$_allItems = that._allItems) || void 0 === _that$_allItems ? void 0 : _that$_allItems.filter((function(it) {
                                    return it.isNewRow
                                })).length) || 0;
                            ...
                            totalItemsCount: function() {
                                if (isVirtualMode(that)) {
                                    ...
                                    var insertRowCount = null !== (_that$getController$g = null === (_that$getController = that.getController("editing")) || void 0 === _that$getController ? void 0 : _that$getController.getInsertRowCount()) && void 0 !== _that$getController$g ? _that$getController$g : 0;
                        ...
                        if ((0, _type.isDefined)(this._loadViewportParams)) {
                            ...
                            if (items.length) {
                                ...
                                result = items.filter((function(it) {
                                    return (it.loadIndex >= startLoadIndex || it.isNewRow && it.loadIndex >= startLoadIndex - 1) && it.loadIndex < startLoadIndex + _this7._loadViewportParams.take
                                }))
                            }
                            return result
                        }
                    ...
                    updateViewport: function() {
                        ...
                        var newTake = null === (_this$_rowsScrollCont2 = this._rowsScrollController) || void 0 === _this$_rowsScrollCont2 ? void 0 : _this$_rowsScrollCont2.getViewportParams().take;

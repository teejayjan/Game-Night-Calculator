...
var SchedulerToolbar = function(_BaseInfernoComponent) {
    ...
    _createClass(SchedulerToolbar, [{
        key: "step",
        get: function() {
            return (0, _utils.getStep)(void 0 !== this.props.currentView ? this.props.currentView : this.state.currentView)
        }
    }, {
        key: "displayedDate",
        get: function() {
            var startViewDate = new Date(this.props.startViewDate);
            if ((0, _utils2.isMonthView)(void 0 !== this.props.currentView ? this.props.currentView : this.state.currentView)) {
        ...
        get: function() {
            ...
            return this.__getterCache.views = (0, _utils2.formatViews)(_this2.props.views)
        }
    }, {
        key: "selectedView",
        get: function() {
        ...
        get: function() {
            ...
            }, _this4.props.items.map((function(item) {

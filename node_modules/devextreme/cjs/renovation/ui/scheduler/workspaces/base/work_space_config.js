...
var getMonthViewConfig = function(crossScrollingEnabled, _, isVerticalGrouping) {
    return {
        headerPanelTemplate: _layout4.HeaderPanelLayout,
...
var getViewRenderConfigByType = function(viewType, crossScrollingEnabled, intervalCount, isVerticalGrouping) {
    return VIEW_CONFIG_GETTERS[viewType](crossScrollingEnabled, intervalCount, isVerticalGrouping)
};

...
var Scheduler = function(_InfernoComponent) {
    ...
    _createClass(Scheduler, [{
        ...
        get: function() {
            ...
            return this.__getterCache.timeZoneCalculator = (0, _common.createTimeZoneCalculator)(_this6.props.timeZone)
        }
    }, {
        ...
        get: function() {
            ...
            return this.__getterCache.filteredItems = (0, _common.filterAppointments)(_this7.appointmentsConfig, _this7.state.dataItems, _this7.dataAccessors, _this7.timeZoneCalculator, _this7.state.loadedResources, _this7.state.viewDataProvider)
        }
    }, {
        ...
        get: function() {
            ...
            return this.__getterCache.appointmentsViewModel = function() {
                if (!_this8.appointmentsConfig || 0 === _this8.filteredItems.length) {
                    return {
                        regular: [],
                        allDay: []
                    }

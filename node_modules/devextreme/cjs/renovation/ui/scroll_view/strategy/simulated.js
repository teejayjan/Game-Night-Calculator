...
var ScrollableSimulated = function(_InfernoComponent) {
    ...
    _proto.updateEffects = function() {
        ...
        null === (_this$_effects$ = this._effects[1]) || void 0 === _this$_effects$ ? void 0 : _this$_effects$.update([this.state.scrolling, this.props.pullDownEnabled, this.props.forceGeneratePockets, this.state.topPocketHeight, this.state.contentClientWidth, this.state.contentScrollWidth, this.state.containerClientWidth, this.state.contentClientHeight, this.state.contentScrollHeight, this.state.containerClientHeight, this.props.direction]);
        null === (_this$_effects$2 = this._effects[2]) || void 0 === _this$_effects$2 ? void 0 : _this$_effects$2.update([this.props.onStart, this.props.pullDownEnabled, this.props.forceGeneratePockets, this.state.topPocketHeight, this.props.direction]);
    ...
    _proto.handleMove = function(e) {
        ...
        null === (_this$hScrollbarRef$c2 = this.hScrollbarRef.current) || void 0 === _this$hScrollbarRef$c2 ? void 0 : _this$hScrollbarRef$c2.moveHandler(e.delta.x);
        null === (_this$vScrollbarRef$c2 = this.vScrollbarRef.current) || void 0 === _this$vScrollbarRef$c2 ? void 0 : _this$vScrollbarRef$c2.moveHandler(e.delta.y)
    };
    ...
    _proto.refresh = function() {
        ...
        this.startLoading();
        null === (_this$props$onPullDow2 = (_this$props9 = this.props).onPullDown) || void 0 === _this$props$onPullDow2 ? void 0 : _this$props$onPullDow2.call(_this$props9, {})
    };
    ...
    _proto.scrollByLocation = function(location) {
        ...
        null === (_this$hScrollbarRef$c7 = this.hScrollbarRef.current) || void 0 === _this$hScrollbarRef$c7 ? void 0 : _this$hScrollbarRef$c7.scrollTo(scrollLeft + location.left);
        null === (_this$vScrollbarRef$c7 = this.vScrollbarRef.current) || void 0 === _this$vScrollbarRef$c7 ? void 0 : _this$vScrollbarRef$c7.scrollTo(scrollTop + location.top);
        this.setState((function(__state_argument) {
            return {
                scrolling: false
            }
    ...
    _createClass(ScrollableSimulated, [{
        ...
        get: function() {
            ...
            return this.__getterCache.direction = new _scroll_direction.ScrollDirection(_this26.props.direction)
        }
    }, {
        ...
        get: function() {
            var _this$props11 = this.props,
                restProps = (_this$props11.addWidgetClass, _this$props11.aria, _this$props11.bounceEnabled, _this$props11.children, _this$props11.classes, _this$props11.direction, _this$props11.disabled, _this$props11.forceGeneratePockets, _this$props11.height, _this$props11.inertiaEnabled, _this$props11.needRenderScrollbars, _this$props11.needScrollViewContentWrapper, _this$props11.needScrollViewLoadPanel, _this$props11.onBounce, _this$props11.onEnd, _this$props11.onPullDown, _this$props11.onReachBottom, _this$props11.onScroll, _this$props11.onStart, _this$props11.onUpdated, _this$props11.onVisibilityChange, _this$props11.pullDownEnabled, _this$props11.pulledDownText, _this$props11.pullingDownText, _this$props11.reachBottomEnabled, _this$props11.reachBottomText, _this$props11.refreshStrategy, _this$props11.refreshingText, _this$props11.rtlEnabled, _this$props11.scrollByContent, _this$props11.scrollByThumb, _this$props11.scrollLocationChange, _this$props11.showScrollbar, _this$props11.useKeyboard, _this$props11.visible, _this$props11.width, _objectWithoutProperties(_this$props11, _excluded));
            return restProps
        }
    }]);

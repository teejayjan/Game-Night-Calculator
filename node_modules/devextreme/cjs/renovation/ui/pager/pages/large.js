...
var PagesLarge = function(_BaseInfernoComponent) {
    ...
    _proto.componentWillUpdate = function(nextProps, nextState, context) {
        if (this.props.pageCount !== nextProps.pageCount || this.props.maxPagesCount !== nextProps.maxPagesCount || this.props.pageIndex !== nextProps.pageIndex) {
            this.__getterCache.pageIndexes = void 0
        }
        if (this.props.pageIndex !== nextProps.pageIndex || this.props.pageIndexChange !== nextProps.pageIndexChange || this.context.ConfigContext !== context.ConfigContext || this.props.pageCount !== nextProps.pageCount || this.props.maxPagesCount !== nextProps.maxPagesCount) {
            this.__getterCache.pages = void 0
        }
    };
    ...
    _createClass(PagesLarge, [{
        ...
        get: function() {
            var _this2 = this;
            if (void 0 !== this.__getterCache.pageIndexes) {
                return this.__getterCache.pageIndexes
            }
            return this.__getterCache.pageIndexes = function() {
                var pageCount = _this2.props.pageCount;
                if (_this2.isSlidingWindowMode()) {
                    return createPageIndexes(0, pageCount, pageCount, "none").pageIndexes
                }
                if (_this2.canReuseSlidingWindow(pageCount, _this2.props.pageIndex)) {
                    var slidingWindowIndexes = _this2.slidingWindowState.slidingWindowIndexes;
                ...
                return _this2.generatePageIndexes()
            }()
        }
    }, {
        key: "pages",
        get: function() {
            var _this3 = this;
            if (void 0 !== this.__getterCache.pages) {
                return this.__getterCache.pages
            }
            return this.__getterCache.pages = (pageIndex = _this3.props.pageIndex, rtlPageIndexes = null !== (_this3$config = _this3.config) && void 0 !== _this3$config && _this3$config.rtlEnabled ? _toConsumableArray(_this3.pageIndexes).reverse() : _this3.pageIndexes, rtlPageIndexes.map((function(index) {
            ...
            var _this3$config, pageIndex, rtlPageIndexes
        }
    }, {
        key: "restAttributes",
        get: function() {

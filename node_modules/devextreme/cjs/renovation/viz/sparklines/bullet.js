...
var Bullet = function(_InfernoWrapperCompon) {
    ...
    _proto.createEffects = function() {
        return [new _inferno2.InfernoEffect(this.tooltipEffect, [this.props.disabled, this.props.onTooltipHidden, this.props.onTooltipShown, this.props.tooltip, this.props.value, this.props.target, this.props.rtlEnabled, this.config, this.state.canvasState, this.state.offsetState]), new _inferno2.InfernoEffect(this.tooltipOutEffect, [this.state.tooltipVisible, this.state.canvasState]), (0, _inferno2.createReRenderEffect)()]
    };
    _proto.updateEffects = function() {
        ...
        null === (_this$_effects$2 = this._effects[1]) || void 0 === _this$_effects$2 ? void 0 : _this$_effects$2.update([this.state.tooltipVisible, this.state.canvasState])
    };

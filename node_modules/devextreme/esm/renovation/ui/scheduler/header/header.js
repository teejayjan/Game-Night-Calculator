...
export class SchedulerToolbar extends BaseInfernoComponent {
    ...
    get step() {
        return getStep(void 0 !== this.props.currentView ? this.props.currentView : this.state.currentView)
    }
    get displayedDate() {
        var startViewDate = new Date(this.props.startViewDate);
        if (isMonthView(void 0 !== this.props.currentView ? this.props.currentView : this.state.currentView)) {

...
import {
    getTranslateValues
} from "../utils/get_translate_values";
import {
    clampIntoRange
...
export var viewFunction = viewModel => {
    var {
        ...
        pendingPointerUp: pendingPointerUp,
        props: {
            aria: aria,
...
export class ScrollableSimulated extends InfernoComponent {
    ...
    scrollLocationChange(eventData) {
        ...
        if ("scrollLeft" === fullScrollProp) {
            this.setState(__state_argument => ({
                hScrollLocation: this.state.scrolling ? -location : clampIntoRange(-location, 0, this.hScrollOffsetMax)
            }))
        } else {
            this.setState(__state_argument => ({
                vScrollLocation: this.state.scrolling ? -location : clampIntoRange(-location, 0, this.vScrollOffsetMax)
            }))
        }

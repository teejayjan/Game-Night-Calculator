    ...
    setContentDimensions(contentEl) {
        ...
        if (this.props.forceGeneratePockets) {
            this.setState(__state_argument => {
                ...
                return {
                    topPocketHeight: null === (_this$topPocketRef = this.topPocketRef) || void 0 === _this$topPocketRef ? void 0 : _this$topPocketRef.current.clientHeight
                }
            });
            this.setState(__state_argument => {
                var _this$bottomPocketRef;
                return {
                    bottomPocketHeight: null === (_this$bottomPocketRef = this.bottomPocketRef) || void 0 === _this$bottomPocketRef ? void 0 : _this$bottomPocketRef.current.clientHeight
                }
            })
        }
    }
